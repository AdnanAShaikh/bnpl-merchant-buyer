  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1.5 text-xs font-medium text-primary border border-primary px-3 py-1.5 rounded-lg hover:bg-primary hover:text-white transition-colors"
      >
        <svg
      ...
      {open && (
        <div className="absolute top-full left-0 mt-2 w-72 bg-white border border-gray-200 rounded-xl shadow-lg z-50 p-4 space-y-3">
          ...
          <div className="bg-blue-50 rounded-lg p-3">
            ...
            <p className="text-lg font-mono font-bold text-blue-600 tracking-widest">
              300200
            </p>
          </div>
        </div>
